...
/**
 * Flink processor for Cartrack trip data.
 * <p>
 * Reads raw Cartrack position data from Kafka, converts it into internal RawTripData,
 * processes it with a universal trip processor, and outputs trip-related events to Kafka.
 * </p>
 */
public class CartrackTripProcessor {

    /**
     * Default constructor.
     */
    public CartrackTripProcessor() {}

    /**
     * Main method to process raw Cartrack position data, perform trip-related transformations,
    ...
    public void process(Config config) throws Exception {
        ...
        try (StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment()) {
            ...
            // Configure Kafka source and deserializer for CartrackPositionRaw
            ...
            env.fromSource(input, WatermarkStrategy.noWatermarks(), "ct:data-raw->trip")
                    .map(raw -> TripAndEventMappers.fromCartrack(raw).build())
